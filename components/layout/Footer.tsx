    ...
    <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              <a href="#" className="mb-6 inline-block">
                <div className="flex items-center w-full xl:gap-x-2">
              ...
              <div className="-mx-3 flex items-center">
                <a href="#" className="px-3 text-[#CDCED6] hover:text-primary">
                  <svg
                    width={10}
                    height={18}
                    viewBox="0 0 10 18"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-dark">Customer</h4>
              <ul>
                <li>
                  <a
                    href="#"
            ...
            <div className="mb-10 w-full">
              ...
              <form className="relative mb-5 w-full overflow-hidden rounded">
                <input
                  ...
                  className="h-12 w-full rounded border px-5 text-sm text-body-color outline-none focus:border-primary focus-visible:shadow-none"
                />
                <button
                  type="submit"
                  onClick={(e) => e.preventDefault()}
                  className="absolute right-0 top-0 flex h-full w-12 items-center justify-center bg-primary text-white hover:bg-dark"
                >
                  <svg
                    width={18}
                    height={13}
              ...
              <p className="text-base text-body-color">© 2030 WindGrids</p>
            </div>
          </div>
        </div>
      </div>
