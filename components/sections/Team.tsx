export function Team() {
  return (
    <section className="overflow-hidden bg-[#F7F8FA] pt-20 pb-20 lg:pt-[120px] lg:pb-[120px]">
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            <div className="group mb-8 rounded-md bg-white px-5 pt-12 pb-10 shadow-card">
              <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="/assets/team/image-01.png"
                  alt="team image"
              ...
              <div className="text-center">
                <h4 className="mb-1 text-lg font-semibold leading-tight text-black">
                  Melissa Tatcher
                </h4>
                ...
                <div className="flex items-center justify-center">
                  <a
                    href="#"
                    className="mx-3 text-[#CDCED6] hover:text-primary"
                  >
                    <svg
                      width={8}
                      height={14}
