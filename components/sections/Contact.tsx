...
export function Contact() {
  return (
    <section id="support" className="overflow-hidden py-24">
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-center">
          <div className="w-full px-4 xl:w-10/12">
            <div className="-mx-4 mb-16 flex flex-wrap bg-primary py-14 px-5 sm:p-14">
              <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-5 flex lg:mb-0">
                  ...
                  <div>
                    ...
                    <p className="text-base font-medium text-[#C1CCF2]">
                      info@example.com
                    </p>
                    <p className="text-base font-medium text-[#C1CCF2]">
                      sales@yourmail.com
